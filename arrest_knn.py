...
# set up the model
if classifier:
    model = MultiOutputClassifier(KNeighborsClassifier(n_neighbors=20,
                                                       weights="uniform",
                                                       leaf_size=10,
                                                       n_jobs=1))
else:
    model = MultiOutputRegressor(KNeighborsRegressor(n_neighbors=20,
                                                     weights="uniform",
                                                     leaf_size=10,
                                                     n_jobs=1))
